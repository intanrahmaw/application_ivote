...
class _EditAccountScreenState extends State<EditAccountScreen> {
  ...
  Future<void> _loadAccountData() async {
    try {
      final idColumn = (loggedInUserRole == 'admin') ? 'admin_id' : 'user_id';
      final data = await supabase
          .from(tableName)
          .select()
          .eq(idColumn, loggedInUserId)
          .single();
  ...
  Future<void> _updateAccount() async {
    ...
    try {
      ...
      await supabase.from(tableName).update(updateData).eq(idColumn, loggedInUserId);
